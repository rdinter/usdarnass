...
[![CRAN Downloads](https://cranlogs.r-pkg.org/badges/usdarnass)](https://cran.r-project.org/package=usdarnass)
...
Thsi package is now on [CRAN](https://cran.r-project.org/) and can be installed through the typical method:
...
See the [Get started](http://robertdinterman.com/usdarnass/articles/usdarnass) article for a more in depth discussion of the package features.
...
If you are interested in download all of the Quick Stats data to your local machine, then their [FTP](ftp://ftp.nass.usda.gov/quickstats/) site is the best option for downloading all.