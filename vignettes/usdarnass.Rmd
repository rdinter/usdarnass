...
There are `r length(agland_params)` parameter values in that query, but only the first 6 are displayed to save space. We can use the output for the parameter values to see the number of observations within each of these categories:

```{r count_agland_short_desc}
sapply(head(agland_params),
